...
---DROP TABLE IF EXISTS da_world.city;
---DROP TABLE IF EXISTS da_world.country;
---DROP TABLE IF EXISTS da_world.countrylanguage;

CREATE SCHEMA da_world;

CREATE TABLE da_world.city (
    id integer NOT NULL,
    name text NOT NULL,
...
CREATE TABLE da_world.countrylanguage (
    countrycode character(3) NOT NULL,
...
INSERT INTO da_world.city VALUES
  ...
  (99, 'Jos�', 'ARG', 'Paz ARG Buenos Aires', 221754),
  ...
  (3563, 'Ciudad''Losada', 'VEN', NULL, 134501),
...
INSERT INTO da_world.country VALUES
  ...
  ('AND', 'Andorra', 'Europe', 'Southern Europe', 468, 1278, 78000, 83.5, 1630.00, NULL, 'Andorra', 'Parliamentary Coprincipality', NULL, 55, 'AD'),
  ...
  ('ATA', 'Antarctica', 'Antarctica', 'Antarctica', 13120000, NULL, 0, NULL, 0.00, NULL, '�', 'Co-administrated', NULL, NULL, 'AQ'),
...
INSERT INTO da_world.countrylanguage VALUES
